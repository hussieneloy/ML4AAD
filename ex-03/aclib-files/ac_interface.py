...
from aclib.configurators.es import ES
from aclib.configurators.es_ext import ESEXT
...
class ACInterface(object):
    ...
    def get_AC(self, ac_name: str):
        ...
        if ac_name == "SMAC2":
            ...
            ac = ES(aclib_root=self.aclib_root, suffix_dir=self.suffix_dir)
        elif ac_name == "ESEXT":
            ac = ESEXT(aclib_root=self.aclib_root, suffix_dir=self.suffix_dir)
        else:
