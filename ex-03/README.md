...
### satenstein
The plots generated by ACLIB had some faults, as the performance curve for SMAC3 and our tool have some upwards steps which is not possible. Unfortunately we did not have enough time to figure out, what the problem was, that these faulty plots were generated, but we generated scatter plots for the first four runs to show, that this was only a problem of plotting and not of our tool (or SMAC3). Both tools optimized the satenstein scenario, as can be seen in the scatter plots.
